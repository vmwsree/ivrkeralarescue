"""Django settings for IVR Management project.
...
APPS_DIR = ROOT_DIR.path('ivr_management')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'ivr_management.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'ivr_management.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'ivr_management.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='IVR Management')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='IVR Management')
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'ivr_management.urls'
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='IVR Management <support@ivr_management.com>')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[IVR Management] ')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/ivr_management'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'ivr_management.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'ivr_management.base.views.csrf_failure'
...
def get_release():
    import ivr_management
    import os
    import raven
    release = ivr_management.__version__
    try:
