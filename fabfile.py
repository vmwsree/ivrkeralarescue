...
#  Settings
# ==========================================================================
env.project_name = 'ivr_management'
...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['dev.ivr_management.com']
    env.dotenv_path = '/home/ubuntu/dev/ivr_management/.env'
...
def qa():
    ...
    env.remote = 'origin'
    env.branch = 'qa'
    env.hosts = ['qa.ivr_management.com']
    env.dotenv_path = '/home/ubuntu/qa/ivr_management/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.ivr_management.com']
    env.dotenv_path = '/home/ubuntu/prod/ivr_management/.env'
    env.config_setter = fab.run
